...
import { FaHeart, FaUser, FaLock, FaStar, FaUserCircle } from 'react-icons/fa';
                ...
                <div className="card fade-in">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <FaUserCircle className="absolute left-4 top-1/2 transform -translate-y-1/2 text-purple-500 text-xl" />
                                <input
                                    type="text"
                                    value={displayName}
